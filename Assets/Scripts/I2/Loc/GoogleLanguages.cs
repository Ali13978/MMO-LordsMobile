...
namespace I2.Loc
{
	public static class GoogleLanguages
	{
		...
		public static string GetGoogleLanguageCode(string InternationalCode)
		{
			foreach (KeyValuePair<string, LanguageCodeDef> item in mLanguageDef)
			{
				...
				if (InternationalCode == value.Code)
				{
					...
					if (value2.GoogleCode == "-")
					{
						return null;
					}
					LanguageCodeDef value3 = item.Value;
					object result;
					if (!string.IsNullOrEmpty(value3.GoogleCode))
					{
						LanguageCodeDef value4 = item.Value;
						result = value4.GoogleCode;
					}
					else
					{
		...
		public static bool LanguageCode_HasJoinedWord(string languageCode)
		{
			...
			{
				LanguageCodeDef value = item.Value;
				if (!(languageCode == value.GoogleCode))
				{
					LanguageCodeDef value2 = item.Value;
					if (!(languageCode == value2.Code))
					{
						continue;
					}
				}
				LanguageCodeDef value3 = item.Value;
				return value3.HasJoinedWords;
			}
			return false;
		}
			...
			default:
				...
				case 3:
				{
					...
					case 12:
						...
						break;
					default:
						result4 = ((!inRange(n, 3, 10) && !inRange(n, 13, 19)) ? 5 : 3);
						break;
					}
					return (ePluralType)result4;
				}
				case 4:
				...
				case 10:
				{
					...
					case 2:
						...
						break;
					default:
						result3 = ((!inRange(n, 3, 6)) ? ((!inRange(n, 7, 10)) ? 5 : 4) : 3);
						break;
					}
					return (ePluralType)result3;
				}
				case 11:
				{
					int result2;
					...
					case 2:
						...
						break;
					default:
						result2 = ((!inRange(n % 100, 3, 10)) ? ((n % 100 < 11) ? 5 : 4) : 3);
						break;
					}
					return (ePluralType)result2;
				}
				case 12:

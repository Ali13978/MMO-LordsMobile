...
namespace VoxelBusters.NativePlugins.Demo
{
	public class UIDemo : NPDemoBase
	{
		...
		protected override void DisplayFeatureFunctionalities()
		{
			...
			GUILayout.Label("Alert Dialogs", "sub-title");
			...
			GUILayout.Label("Prompt Dialogs", "sub-title");
			...
			GUILayout.Label("Toast", "sub-title");
		...
		{
			NPBinding.UI.ShowAlertDialogWithSingleButton(m_title, m_message, m_button, delegate(string _buttonPressed)
			{

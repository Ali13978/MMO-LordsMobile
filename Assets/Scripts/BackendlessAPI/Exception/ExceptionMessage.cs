namespace BackendlessAPI.Exception
{
	public class ExceptionMessage
	{
		...
		public const string NULL_CONTEXT = "Context cannot be null. Use Backendless.initApp( Context context, String applicationId, String secretKey, String version ) for proper initialization.";
		...
		public const string WRONG_SEARCH_RECTANGLE_QUERY = "Wrong rectangle search query. It should contain four points.";
		...
		public const string INCONSISTENT_GEO_QUERY = "Inconsistent geo query. Query should not contain both rectangle and radius search parameters.";
		...
		public const string SERVICE_NOT_DECLARED = "com.backendless.AndroidService is not declared at the application manifest";

		public const string LOCAL_FILE_EXISTS = "Local file exists";

		public const string WRONG_REMOTE_PATH = "Remote path cannot be empty";

		public const string NO_DEVICEID_CAPABILITY = "In order to use Backendless SDK in WindowsPhone environment, application should have an 'ID_CAP_IDENTITY_DEVICE' capability";
